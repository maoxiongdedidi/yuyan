...
//                                    return refreshTokenWhenTokenInvalid(viewModel.getApplication());
//                                }  else {
                        ...
                        if (loginBeanBaseBean.isSuccess()) {
                            if (loginBeanBaseBean.getReturnCode().equals("200")) {
                                if (TextUtils.isEmpty(loginBeanBaseBean.getErrorCode())) {
                                    ...
                                    updataaccounid(baseBeanObservable, viewModel, httpInterFace);
                            ...
                            if (loginBeanBaseBean.getReturnCode().equals("1005")) {
