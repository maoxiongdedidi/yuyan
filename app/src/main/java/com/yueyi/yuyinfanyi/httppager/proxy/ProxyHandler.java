...
package com.yueyi.yuyinfanyi.httppager.proxy;
...
import com.yueyi.yuyinfanyi.httppager.IGlobalManager;
import com.yueyi.yuyinfanyi.httppager.ReLogin;
                        ...
                        .subscribe(new Consumer<BaseBean<String>>() {
                            ...
                            public void accept(BaseBean<String> stringBaseBean) throws Exception {
                                if (stringBaseBean.getResult() != null) {
                                    ...
                                    UserPreference.getInstance(MyApplication.getInstance().getBaseContext()).setaccountId(stringBaseBean.getResult());
                                }else {
